...
public:
	CExpertMethodDlg(ClientConnectionModule* pModule, std::vector<Car>& lst, CWnd* pParent = nullptr);   // standard constructor
...
protected:
	...
	std::vector<Car>& m_Selected;
	std::list<Car> m_Objects;
};
