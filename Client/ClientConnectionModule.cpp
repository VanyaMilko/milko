...
AnswerFromServer ClientConnectionModule::editOneObj(Car& dish)
{
...
AnswerFromServer ClientConnectionModule::addOneObj(Car& dish)
{
...
AnswerFromServer ClientConnectionModule::delOneObj(Car& dish)
{
...
std::list<Car> ClientConnectionModule::getAllObj()
{
    protocol.sendCommand(CommandToServer::GET_ALL_OBJECT);
    return protocol.receiveList<Car>();
}
